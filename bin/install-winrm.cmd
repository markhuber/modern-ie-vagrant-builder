...
if not exist C:\Users\IEUser\bin\fixnetwork.ps1 echo ==^> ERROR: File not found: C:\Users\IEUser\bin\fixnetwork.ps1
...
powershell -File C:\Users\IEUser\bin\fixnetwork.ps1 <NUL
@if errorlevel 1 echo ==^> WARNING: Error %ERRORLEVEL% was returned by: powershell -File C:\Users\IEUser\bin\fixnetwork.ps1
